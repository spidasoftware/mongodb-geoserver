...
class FilterToDBQuerySpec extends Specification {
    ...
    void "test Id query"() {
        ...
        where:
            ...
            "asset"        | "designs"      | "56e9b7137d84511d8dd0f13c_POLE"                                      | new BasicDBObject("id", "56e9b7137d84511d8dd0f13c")                                                                                                       | 1
            "asset"        | "designs"      | "56e9b7137d84511d8dd0f13c_ANALYSIS_0"                                | new BasicDBObject("id", "56e9b7137d84511d8dd0f13c")                                                                                                       | 1
    ...
    void "test formField property queries"() {
        ...
        where:
            ...
            "value exists"            | CQL.toFilter("value='TesterValue123'")                                                      | new BasicDBObject()  /*TODO*/                                                                                                                             | 1
            "value doesn't exist"     | CQL.toFilter("value='TEST'")                                                                | new BasicDBObject()  /*TODO*/                                                                                                                             | 0
    ...
    @Unroll("Test asset property query for #description")
    void "test asset property queries"() {
        setup:
        ...
        where:
            description                            | filter                                                               | expectedQuery                                                                                           | expectedSize
            "analysis asset type"                  | CQL.toFilter("${"assetType"}='ANALYSIS'")                            | new BasicDBObject()                                                                                     | 3
            "pole asset type"                      | CQL.toFilter("${"assetType"}='POLE'")                                | new BasicDBObject()                                                                                     | 1
            "asset type that doesn't exist"        | CQL.toFilter("${"assetType"}='TEST'")                                | new BasicDBObject()                                                                                     | 0

            "design type that exists"              | CQL.toFilter("designType='Measured Design'")                         | new BasicDBObject("calcDesign.label", "Measured Design")                                                | 4
            ...
            "location label that exists"           | CQL.toFilter("locationLabel='684704E'")                              | new BasicDBObject("locationLabel", "684704E")                                                           | 4
            "location label that doesn't exist"    | CQL.toFilter("locationLabel='TEST'")                                 | new BasicDBObject("locationLabel", "TEST")                                                              | 0

            "locationId that exists"               | CQL.toFilter("locationId='55fac7fde4b0e7f2e3be342c'")                | new BasicDBObject("locationId", "55fac7fde4b0e7f2e3be342c")                                             | 4
            "locationId that doesn't exist"        | CQL.toFilter("locationId='TEST'")                                    | new BasicDBObject("locationId", "TEST")                                                                 | 0

            "clientFile that exists"               | CQL.toFilter("clientFile='SCE.client'")                              | new BasicDBObject("clientFile", "SCE.client")                                                           | 4
            "clientFile that doesn't exist"        | CQL.toFilter("clientFile='AEP.client'")                              | new BasicDBObject("clientFile", "AEP.client")                                                           | 0

            "clientFileVersion that exists"        | CQL.toFilter("clientFileVersion='6ee5fba14760878be22701e1b3b7c05b'") | new BasicDBObject("clientFileVersion", "6ee5fba14760878be22701e1b3b7c05b")                              | 4
            "clientFileVersion that doesn't exist" | CQL.toFilter("clientFileVersion='TEST'")                             | new BasicDBObject("clientFileVersion", "TEST")                                                          | 0

            "dateModified that exists"             | CQL.toFilter("dateModified=1442498557079")                           | new BasicDBObject("dateModified", 1442498557079)                                                        | 4
            "dateModified that doesn't exist"      | CQL.toFilter("dateModified=3333333")                                 | new BasicDBObject("dateModified", 3333333)                                                              | 0
            "dateModified gt exists"               | CQL.toFilter("dateModified>1442498557078")                           | new BasicDBObject("dateModified", new BasicDBObject('$gt', 1442498557078))                              | 4
            "dateModified gt doesn't exist"        | CQL.toFilter("dateModified>1442498557080")                           | new BasicDBObject("dateModified", new BasicDBObject('$gt', 1442498557080))                              | 0
            "dateModified gte exists"              | CQL.toFilter("dateModified>=1442498557079")                          | new BasicDBObject("dateModified", new BasicDBObject('$gte', 1442498557079))                             | 4
            "dateModified gte doesn't exist"       | CQL.toFilter("dateModified>=1442498557080")                          | new BasicDBObject("dateModified", new BasicDBObject('$gte', 1442498557080))                             | 0
            "dateModified lt exists"               | CQL.toFilter("dateModified<1442498557080")                           | new BasicDBObject("dateModified", new BasicDBObject('$lt', 1442498557080))                              | 4
            "dateModified lt doesn't exist"        | CQL.toFilter("dateModified<1442498557079")                           | new BasicDBObject("dateModified", new BasicDBObject('$lt', 1442498557079))                              | 0
            "dateModified lte exists"              | CQL.toFilter("dateModified<=1442498557079")                          | new BasicDBObject("dateModified", new BasicDBObject('$lte', 1442498557079))                             | 4
            "dateModified lte doesn't exist"       | CQL.toFilter("dateModified<=1442498557078")                          | new BasicDBObject("dateModified", new BasicDBObject('$lte', 1442498557078))                             | 0

            "glc that exists"                      | CQL.toFilter("glc=2.8990375130504664")                               | new BasicDBObject("calcDesign.structure.pole.glc.value", 2.8990375130504664)                            | 4
            "glc that doesn't exist"               | CQL.toFilter("glc=3333333")                                          | new BasicDBObject("calcDesign.structure.pole.glc.value", 3333333)                                       | 0
            "glc gt exists"                        | CQL.toFilter("glc>2")                                                | new BasicDBObject("calcDesign.structure.pole.glc.value", new BasicDBObject('$gt', 2))                   | 4
            "glc gt doesn't exist"                 | CQL.toFilter("glc>3")                                                | new BasicDBObject("calcDesign.structure.pole.glc.value", new BasicDBObject('$gt', 3))                   | 0
            "glc gte exists"                       | CQL.toFilter("glc>=2.8990375130504664")                              | new BasicDBObject("calcDesign.structure.pole.glc.value", new BasicDBObject('$gte', 2.8990375130504664)) | 4
            "glc gte doesn't exist"                | CQL.toFilter("glc>=3")                                               | new BasicDBObject("calcDesign.structure.pole.glc.value", new BasicDBObject('$gte', 3))                  | 0
            "glc lt exists"                        | CQL.toFilter("glc<3")                                                | new BasicDBObject("calcDesign.structure.pole.glc.value", new BasicDBObject('$lt', 3))                   | 4
            "glc lt doesn't exist"                 | CQL.toFilter("glc<2")                                                | new BasicDBObject("calcDesign.structure.pole.glc.value", new BasicDBObject('$lt', 2))                   | 0
            "glc lte exists"                       | CQL.toFilter("glc<=2.8990375130504664")                              | new BasicDBObject("calcDesign.structure.pole.glc.value", new BasicDBObject('$lte', 2.8990375130504664)) | 4
            "glc lte doesn't exist"                | CQL.toFilter("glc<=2")                                               | new BasicDBObject("calcDesign.structure.pole.glc.value", new BasicDBObject('$lte', 2))                  | 0

            "agl that exists"                      | CQL.toFilter("agl=38.5")                                             | new BasicDBObject("calcDesign.structure.pole.agl.value", 38.5)                                          | 4
            "agl that doesn't exist"               | CQL.toFilter("agl=3333333")                                          | new BasicDBObject("calcDesign.structure.pole.agl.value", 3333333)                                       | 0
            "agl gt exists"                        | CQL.toFilter("agl>2")                                                | new BasicDBObject("calcDesign.structure.pole.agl.value", new BasicDBObject('$gt', 2))                   | 4
            "agl gt doesn't exist"                 | CQL.toFilter("agl>40")                                               | new BasicDBObject("calcDesign.structure.pole.agl.value", new BasicDBObject('$gt', 40))                  | 0
            "agl gte exists"                       | CQL.toFilter("agl>=38.5")                                            | new BasicDBObject("calcDesign.structure.pole.agl.value", new BasicDBObject('$gte', 38.5))               | 4
            ...
            "agl lt exists"                        | CQL.toFilter("agl<40")                                               | new BasicDBObject("calcDesign.structure.pole.agl.value", new BasicDBObject('$lt', 40))                  | 4
            "agl lt doesn't exist"                 | CQL.toFilter("agl<30")                                               | new BasicDBObject("calcDesign.structure.pole.agl.value", new BasicDBObject('$lt', 30))                  | 0
            "agl lte exists"                       | CQL.toFilter("agl<=38.5")                                            | new BasicDBObject("calcDesign.structure.pole.agl.value", new BasicDBObject('$lte', 38.5))               | 4
            ...
            "species does exist"                   | CQL.toFilter("species='Southern Yellow Pine'")                       | new BasicDBObject("calcDesign.structure.pole.clientItem.species", "Southern Yellow Pine")               | 4
            "species doesn't exist"                | CQL.toFilter("species='TEST'")                                       | new BasicDBObject("calcDesign.structure.pole.clientItem.species", "TEST")                               | 0

            "class does exist"                     | CQL.toFilter("class='4'")                                            | new BasicDBObject("calcDesign.structure.pole.clientItem.classOfPole", "4")                              | 4
            "class doesn't exist"                  | CQL.toFilter("class='5'")                                            | new BasicDBObject("calcDesign.structure.pole.clientItem.classOfPole", "5")                              | 0

            "length that exists"                   | CQL.toFilter("length=45")                                            | new BasicDBObject("calcDesign.structure.pole.clientItem.height.value", 45)                              | 4
            ...
            "length gt exists"                     | CQL.toFilter("length>40")                                            | new BasicDBObject("calcDesign.structure.pole.clientItem.height.value", new BasicDBObject('$gt', 40))    | 4
            ...
            "length gte exists"                    | CQL.toFilter("length>=45")                                           | new BasicDBObject("calcDesign.structure.pole.clientItem.height.value", new BasicDBObject('$gte', 45))   | 4
            ...
            "length lt exists"                     | CQL.toFilter("length<46")                                            | new BasicDBObject("calcDesign.structure.pole.clientItem.height.value", new BasicDBObject('$lt', 46))    | 4
            ...
            "length lte exists"                    | CQL.toFilter("length<=45")                                           | new BasicDBObject("calcDesign.structure.pole.clientItem.height.value", new BasicDBObject('$lte', 45))   | 4
            ...
            "owner does exist"                     | CQL.toFilter("owner='Acme Power'")                                   | new BasicDBObject("calcDesign.structure.pole.owner.id", "Acme Power")                                   | 4
            ...
            "id that exists"                       | CQL.toFilter("id='56e9b7137d84511d8dd0f13c_POLE'")                   | new BasicDBObject("id", "56e9b7137d84511d8dd0f13c")                                                     | 1
            "id that doesn't exist"                | CQL.toFilter("id='TEST'")                                            | new BasicDBObject("id", "TEST")                                                                         | 0
    }
    ...
    void "test wire property queries"() {
        ...
        where:
            ...
            "assetId that exists"                  | CQL.toFilter("assetId='56e9b7137d84511d8dd0f13c_POLE'") | new BasicDBObject("id", "56e9b7137d84511d8dd0f13c")                                                                   | 2
            "assetId that doesn't exist"           | CQL.toFilter("assetId='Measured Design'")               | new BasicDBObject("id", "Measured Design")                                                                            | 0
    }
    ...
    void "test spanPoint property queries"() {
        ...
        where:
            ...
            "assetId that exists"         | CQL.toFilter("assetId='56e9b7137d84511d8dd0f13c_POLE'") | new BasicDBObject("id", "56e9b7137d84511d8dd0f13c")                                                | 1
            "assetId that doesn't exist"  | CQL.toFilter("assetId='Measured Design'")               | new BasicDBObject("id", "Measured Design")                                                         | 0
    }
